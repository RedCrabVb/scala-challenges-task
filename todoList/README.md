...
Для операции над заметками их не обходимо загрузить с сервера, 
делается это командой ```2. Show notes```, 
если загрузка происходила с помощью фильтра, то данные не сохраняться